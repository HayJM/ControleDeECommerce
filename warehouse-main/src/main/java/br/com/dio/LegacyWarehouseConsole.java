...
/**
 * Legacy console application for warehouse management.
 * This class contains the original console-based functionality.
 * The Spring Boot application is now in WarehouseApplication.java
 */
public class LegacyWarehouseConsole {
